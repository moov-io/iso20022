...
func (doc *DocumentPain00100110) InspectDocument() interface{} {
	return &doc.CstmrCdtTrfInitn
}
...
func (doc *DocumentPain00700110) InspectDocument() interface{} {
	return &doc.CstmrPmtRvsl
}
