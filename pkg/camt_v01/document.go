...
func (doc *DocumentCamt10100101) GetXmlName() *xml.Name {
	return &doc.XMLName
}

func (doc *DocumentCamt10100101) GetAttrs() []utils.Attr {
	return doc.Attrs
}

func (doc *DocumentCamt10100101) InspectDocument() interface{} {
	return &doc.CretLmt
}
...
func (doc *DocumentCamt10200101) GetXmlName() *xml.Name {
	return &doc.XMLName
}

func (doc *DocumentCamt10200101) GetAttrs() []utils.Attr {
	return doc.Attrs
}

func (doc *DocumentCamt10200101) InspectDocument() interface{} {
	return &doc.CretStgOrdr
}
...
func (doc *DocumentCamt10300101) GetXmlName() *xml.Name {
	return &doc.XMLName
}

func (doc *DocumentCamt10300101) GetAttrs() []utils.Attr {
	return doc.Attrs
}

func (doc *DocumentCamt10300101) InspectDocument() interface{} {
	return &doc.CretRsvatn
}
...
func (doc *DocumentCamt10400101) GetXmlName() *xml.Name {
	return &doc.XMLName
}

func (doc *DocumentCamt10400101) GetAttrs() []utils.Attr {
	return doc.Attrs
}

func (doc *DocumentCamt10400101) InspectDocument() interface{} {
	return &doc.CretMmb
}
