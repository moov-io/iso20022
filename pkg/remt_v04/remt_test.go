...
func TestDocumentRemt00100104(t *testing.T) {
	sample := DocumentRemt00100104{}
	err := sample.Validate()
	assert.NotNil(t, err)
	...
	assert.Nil(t, err)
	assert.Equal(t, string(buf), `{"Xmlns":"urn:iso:std:iso:20022:tech:xsd:remt.001.001.04","RmtAdvc":{"GrpHdr":{"MsgId":"MsgId","CreDtTm":"2014-11-12T11:45:26.371","InitgPty":{}}}}`)

	buf, err = xml.Marshal(&sample)
	assert.Nil(t, err)
	assert.Equal(t, string(buf), `<Document xmlns="urn:iso:std:iso:20022:tech:xsd:remt.001.001.04" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><RmtAdvc><GrpHdr><MsgId>MsgId</MsgId><CreDtTm>2014-11-12T11:45:26.371</CreDtTm><InitgPty></InitgPty></GrpHdr></RmtAdvc></Document>`)
}
...
func TestNestedTypes(t *testing.T) {
	...
	assert.NotNil(t, OriginalPaymentInformation8{}.Validate())
	...
	assert.NotNil(t, RemittanceAdviceV04{}.Validate())
	assert.Nil(t, RemittanceAmount2{}.Validate())
	assert.Nil(t, RemittanceAmount3{}.Validate())
	assert.NotNil(t, RemittanceInformation19{}.Validate())
...
func TestTypes(t *testing.T) {
	...
	var type14 ExternalTaxAmountType1Code
	assert.NotNil(t, type14.Validate())
	type14 = "test"
	assert.Nil(t, type14.Validate())

	var type15 TaxRecordPeriod1Code
	...
	var type16 PreferredContactMethod1Code
	...
	var type18 ExchangeRateType1Code
