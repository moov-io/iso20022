...
func (doc *DocumentRemt00100104) GetXmlName() *xml.Name {
	return &doc.XMLName
}

func (doc *DocumentRemt00100104) GetAttrs() []utils.Attr {
	return doc.Attrs
}

func (doc *DocumentRemt00100104) InspectDocument() interface{} {
	return &doc.RmtAdvc
}
