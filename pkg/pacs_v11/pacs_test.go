...
func TestDocumentPacs00200111(t *testing.T) {
	...
	assert.Nil(t, err)
	assert.Equal(t,
		`<DocumentPacs00200111><FIToFIPmtStsRpt><GrpHdr><MsgId>MsgId</MsgId><CreDtTm>2014-11-12T11:45:26.371</CreDtTm></GrpHdr></FIToFIPmtStsRpt></DocumentPacs00200111>`,
		string(buf))
}
...
func TestNestedTypes(t *testing.T) {
	...
	assert.NotNil(t, FIToFIPaymentStatusReportV11{}.Validate())
	...
	assert.Nil(t, PaymentTransaction123{}.Validate())
...
func TestTypes(t *testing.T) {
	...
	var type5 ExternalStatusReason1Code
	...
	var type31 ExternalPaymentTransactionStatus1Code
	assert.NotNil(t, type31.Validate())
	type31 = "test"
	assert.Nil(t, type31.Validate())

	var type32 ExternalPaymentGroupStatus1Code
