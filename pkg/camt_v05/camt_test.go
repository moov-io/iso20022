...
func TestDocumentCamt01800105(t *testing.T) {
	...
	assert.Nil(t, err)
	assert.Equal(t, string(buf), `{"GetBizDayInf":{"MsgHdr":{"MsgId":"Id"}}}`)

	buf, err = xml.Marshal(&sample)
	assert.Nil(t, err)
	assert.Equal(t, string(buf), `<Document xmlns="urn:iso:std:iso:20022:tech:xsd:camt.018.001.05" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><GetBizDayInf xmlns="urn:iso:std:iso:20022:tech:xsd:camt.018.001.05"><MsgHdr><MsgId>Id</MsgId></MsgHdr></GetBizDayInf></Document>`)
}
...
func TestDocumentCamt02500105(t *testing.T) {
	...
	buf, err := json.Marshal(&sample)
	assert.Nil(t, err)
	assert.Equal(t, string(buf), `{"Rct":{"MsgHdr":{"MsgId":"Id"}}}`)

	buf, err = xml.Marshal(&sample)
	assert.Nil(t, err)
	assert.Equal(t, string(buf), `<Document xmlns="urn:iso:std:iso:20022:tech:xsd:camt.025.001.05" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><Rct xmlns="urn:iso:std:iso:20022:tech:xsd:camt.025.001.05"><MsgHdr><MsgId>Id</MsgId></MsgHdr></Rct></Document>`)
}
...
func TestDocumentCamt03000105(t *testing.T) {
	...
	buf, err := json.Marshal(&sample)
	assert.Nil(t, err)
	assert.Equal(t, string(buf), `{"NtfctnOfCaseAssgnmt":{"Hdr":{"Id":"Id","Fr":{"Pty":{},"Agt":{"FinInstnId":{}}},"To":{"Pty":{},"Agt":{"FinInstnId":{}}},"CreDtTm":"2014-11-12T11:45:26.371"},"Case":{"Id":"Id","Cretr":{"Pty":{},"Agt":{"FinInstnId":{}}}},"Assgnmt":{"Id":"Id","Assgnr":{"Pty":{},"Agt":{"FinInstnId":{}}},"Assgne":{"Pty":{},"Agt":{"FinInstnId":{}}},"CreDtTm":"2014-11-12T11:45:26.371"},"Ntfctn":{"Justfn":"MINE"}}}`)

	buf, err = xml.Marshal(&sample)
	assert.Nil(t, err)
	assert.Equal(t, string(buf), `<Document xmlns="urn:iso:std:iso:20022:tech:xsd:camt.030.001.05" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><NtfctnOfCaseAssgnmt xmlns="urn:iso:std:iso:20022:tech:xsd:camt.030.001.05"><Hdr><Id>Id</Id><Fr><Pty></Pty><Agt><FinInstnId></FinInstnId></Agt></Fr><To><Pty></Pty><Agt><FinInstnId></FinInstnId></Agt></To><CreDtTm>2014-11-12T11:45:26.371</CreDtTm></Hdr><Case><Id>Id</Id><Cretr><Pty></Pty><Agt><FinInstnId></FinInstnId></Agt></Cretr></Case><Assgnmt><Id>Id</Id><Assgnr><Pty></Pty><Agt><FinInstnId></FinInstnId></Agt></Assgnr><Assgne><Pty></Pty><Agt><FinInstnId></FinInstnId></Agt></Assgne><CreDtTm>2014-11-12T11:45:26.371</CreDtTm></Assgnmt><Ntfctn><Justfn>MINE</Justfn></Ntfctn></NtfctnOfCaseAssgnmt></Document>`)
}
...
func TestDocumentCamt03500105(t *testing.T) {
	...
	buf, err := json.Marshal(&sample)
	assert.Nil(t, err)
	assert.Equal(t, string(buf), `{"PrtryFrmtInvstgtn":{"Assgnmt":{"Id":"Id","Assgnr":{"Pty":{},"Agt":{"FinInstnId":{}}},"Assgne":{"Pty":{},"Agt":{"FinInstnId":{}}},"CreDtTm":"2014-11-12T11:45:26.371"},"PrtryData":{"Tp":"Id","Data":{"Any":{"Item":""}}}}}`)

	buf, err = xml.Marshal(&sample)
	assert.Nil(t, err)
	assert.Equal(t, string(buf), `<Document xmlns="urn:iso:std:iso:20022:tech:xsd:camt.035.001.05" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><PrtryFrmtInvstgtn xmlns="urn:iso:std:iso:20022:tech:xsd:camt.035.001.05"><Assgnmt><Id>Id</Id><Assgnr><Pty></Pty><Agt><FinInstnId></FinInstnId></Agt></Assgnr><Assgne><Pty></Pty><Agt><FinInstnId></FinInstnId></Agt></Assgne><CreDtTm>2014-11-12T11:45:26.371</CreDtTm></Assgnmt><PrtryData><Tp>Id</Tp><Data><Any><Item></Item></Any></Data></PrtryData></PrtryFrmtInvstgtn></Document>`)
}
...
func TestDocumentCamt04800105(t *testing.T) {
	...
	buf, err := json.Marshal(&sample)
	assert.Nil(t, err)
	assert.Equal(t, string(buf), `{"ModfyRsvatn":{"MsgHdr":{"MsgId":"Id"},"RsvatnId":{"Cur":{"Tp":{"Cd":"BLKD","Prtry":"Prtry"}},"Dflt":{"Tp":{"Cd":"BLKD","Prtry":"Prtry"}}},"NewRsvatnValSet":{"Amt":{"AmtWthtCcy":0,"AmtWthCcy":{"Value":0,"Ccy":"ABC"}}}}}`)

	buf, err = xml.Marshal(&sample)
	assert.Nil(t, err)
	assert.Equal(t, string(buf), `<Document xmlns="urn:iso:std:iso:20022:tech:xsd:camt.048.001.05" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><ModfyRsvatn xmlns="urn:iso:std:iso:20022:tech:xsd:camt.048.001.05"><MsgHdr><MsgId>Id</MsgId></MsgHdr><RsvatnId><Cur><Tp><Cd>BLKD</Cd><Prtry>Prtry</Prtry></Tp></Cur><Dflt><Tp><Cd>BLKD</Cd><Prtry>Prtry</Prtry></Tp></Dflt></RsvatnId><NewRsvatnValSet><Amt><AmtWthtCcy>0</AmtWthtCcy><AmtWthCcy Ccy="ABC">0</AmtWthCcy></Amt></NewRsvatnValSet></ModfyRsvatn></Document>`)
}
...
func TestDocumentCamt03600105(t *testing.T) {
	...
	buf, err := json.Marshal(&sample)
	assert.Nil(t, err)
	assert.Equal(t, string(buf), `{"DbtAuthstnRspn":{"Assgnmt":{"Id":"Id","Assgnr":{"Pty":{},"Agt":{"FinInstnId":{}}},"Assgne":{"Pty":{},"Agt":{"FinInstnId":{}}},"CreDtTm":"2014-11-12T11:45:26.371"},"Case":{"Id":"Id","Cretr":{"Pty":{},"Agt":{"FinInstnId":{}}}},"Conf":{"DbtAuthstn":false}}}`)

	buf, err = xml.Marshal(&sample)
	assert.Nil(t, err)
	assert.Equal(t, string(buf), `<Document xmlns="urn:iso:std:iso:20022:tech:xsd:camt.036.001.05" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><DbtAuthstnRspn xmlns="urn:iso:std:iso:20022:tech:xsd:camt.036.001.05"><Assgnmt><Id>Id</Id><Assgnr><Pty></Pty><Agt><FinInstnId></FinInstnId></Agt></Assgnr><Assgne><Pty></Pty><Agt><FinInstnId></FinInstnId></Agt></Assgne><CreDtTm>2014-11-12T11:45:26.371</CreDtTm></Assgnmt><Case><Id>Id</Id><Cretr><Pty></Pty><Agt><FinInstnId></FinInstnId></Agt></Cretr></Case><Conf><DbtAuthstn>false</DbtAuthstn></Conf></DbtAuthstnRspn></Document>`)
}
...
func TestDocumentCamt04900105(t *testing.T) {
	...
	buf, err := json.Marshal(&sample)
	assert.Nil(t, err)
	assert.Equal(t, string(buf), `{"DelRsvatn":{"MsgHdr":{"MsgId":"Id"}}}`)

	buf, err = xml.Marshal(&sample)
	assert.Nil(t, err)
	assert.Equal(t, string(buf), `<Document xmlns="urn:iso:std:iso:20022:tech:xsd:camt.049.001.05" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><DelRsvatn xmlns="urn:iso:std:iso:20022:tech:xsd:camt.049.001.05"><MsgHdr><MsgId>Id</MsgId></MsgHdr></DelRsvatn></Document>`)
}
...
func TestDocumentCamt05000105(t *testing.T) {
	...
	buf, err := json.Marshal(&sample)
	assert.Nil(t, err)
	assert.Equal(t, string(buf), `{"LqdtyCdtTrf":{"MsgHdr":{"MsgId":"Id"},"LqdtyCdtTrf":{"TrfdAmt":{"AmtWthtCcy":0,"AmtWthCcy":{"Value":0,"Ccy":"ABC"}}}}}`)

	buf, err = xml.Marshal(&sample)
	assert.Nil(t, err)
	assert.Equal(t, string(buf), `<Document xmlns="urn:iso:std:iso:20022:tech:xsd:camt.050.001.05" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><LqdtyCdtTrf xmlns="urn:iso:std:iso:20022:tech:xsd:camt.050.001.05"><MsgHdr><MsgId>Id</MsgId></MsgHdr><LqdtyCdtTrf><TrfdAmt><AmtWthtCcy>0</AmtWthtCcy><AmtWthCcy Ccy="ABC">0</AmtWthCcy></TrfdAmt></LqdtyCdtTrf></LqdtyCdtTrf></Document>`)
}
...
func TestDocumentCamt03900105(t *testing.T) {
	...
	buf, err := json.Marshal(&sample)
	assert.Nil(t, err)
	assert.Equal(t, string(buf), `{"CaseStsRpt":{"Hdr":{"Id":"Id","Fr":{"Pty":{},"Agt":{"FinInstnId":{}}},"To":{"Pty":{},"Agt":{"FinInstnId":{}}},"CreDtTm":"2014-11-12T11:45:26.371"},"Case":{"Id":"Id","Cretr":{"Pty":{},"Agt":{"FinInstnId":{}}}},"Sts":{"DtTm":"2014-11-12T11:45:26.371","CaseSts":"ODUE"}}}`)

	buf, err = xml.Marshal(&sample)
	assert.Nil(t, err)
	assert.Equal(t, string(buf), `<Document xmlns="urn:iso:std:iso:20022:tech:xsd:camt.039.001.05" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><CaseStsRpt xmlns="urn:iso:std:iso:20022:tech:xsd:camt.039.001.05"><Hdr><Id>Id</Id><Fr><Pty></Pty><Agt><FinInstnId></FinInstnId></Agt></Fr><To><Pty></Pty><Agt><FinInstnId></FinInstnId></Agt></To><CreDtTm>2014-11-12T11:45:26.371</CreDtTm></Hdr><Case><Id>Id</Id><Cretr><Pty></Pty><Agt><FinInstnId></FinInstnId></Agt></Cretr></Case><Sts><DtTm>2014-11-12T11:45:26.371</DtTm><CaseSts>ODUE</CaseSts></Sts></CaseStsRpt></Document>`)
}
...
func TestDocumentCamt04600105(t *testing.T) {
	...
	buf, err := json.Marshal(&sample)
	assert.Nil(t, err)
	assert.Equal(t, string(buf), `{"GetRsvatn":{"MsgHdr":{"MsgId":"Id"}}}`)

	buf, err = xml.Marshal(&sample)
	assert.Nil(t, err)
	assert.Equal(t, string(buf), `<Document xmlns="urn:iso:std:iso:20022:tech:xsd:camt.046.001.05" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><GetRsvatn xmlns="urn:iso:std:iso:20022:tech:xsd:camt.046.001.05"><MsgHdr><MsgId>Id</MsgId></MsgHdr></GetRsvatn></Document>`)
}
...
func TestDocumentCamt05100105(t *testing.T) {
	...
	buf, err := json.Marshal(&sample)
	assert.Nil(t, err)
	assert.Equal(t, string(buf), `{"LqdtyDbtTrf":{"MsgHdr":{"MsgId":"Id"},"LqdtyDbtTrf":{"TrfdAmt":null}}}`)

	buf, err = xml.Marshal(&sample)
	assert.Nil(t, err)
	assert.Equal(t, string(buf), `<Document xmlns="urn:iso:std:iso:20022:tech:xsd:camt.051.001.05" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><LqdtyDbtTrf xmlns="urn:iso:std:iso:20022:tech:xsd:camt.051.001.05"><MsgHdr><MsgId>Id</MsgId></MsgHdr><LqdtyDbtTrf></LqdtyDbtTrf></LqdtyDbtTrf></Document>`)
}
...
func TestDocumentCamt01800108(t *testing.T) {
	...
	buf, err := json.Marshal(&sample)
	assert.Nil(t, err)
	assert.Equal(t, string(buf), `{"AcctRptgReq":{"GrpHdr":{"MsgId":"Id","CreDtTm":"2014-11-12T11:45:26.371"}}}`)

	buf, err = xml.Marshal(&sample)
	assert.Nil(t, err)
	assert.Equal(t, string(buf), `<Document xmlns="urn:iso:std:iso:20022:tech:xsd:camt.060.001.05" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><AcctRptgReq xmlns="urn:iso:std:iso:20022:tech:xsd:camt.060.001.05"><GrpHdr><MsgId>Id</MsgId><CreDtTm>2014-11-12T11:45:26.371</CreDtTm></GrpHdr></AcctRptgReq></Document>`)
}
...
func TestNestedTypes(t *testing.T) {
	...
	assert.Nil(t, LiquidityDebitTransfer2{}.Validate())
