...
func (doc *DocumentCamt02100106) GetXmlName() *xml.Name {
	return &doc.XMLName
}

func (doc *DocumentCamt02100106) GetAttrs() []utils.Attr {
	return doc.Attrs
}

func (doc *DocumentCamt02100106) InspectDocument() interface{} {
	return &doc.RtrGnlBizInf
}
...
func (doc *DocumentCamt02400106) GetXmlName() *xml.Name {
	return &doc.XMLName
}

func (doc *DocumentCamt02400106) GetAttrs() []utils.Attr {
	return doc.Attrs
}

func (doc *DocumentCamt02400106) InspectDocument() interface{} {
	return &doc.ModfyStgOrdr
}
...
func (doc *DocumentCamt02900106) GetXmlName() *xml.Name {
	return &doc.XMLName
}

func (doc *DocumentCamt02900106) GetAttrs() []utils.Attr {
	return doc.Attrs
}

func (doc *DocumentCamt02900106) InspectDocument() interface{} {
	return &doc.RsltnOfInvstgtn
}
...
func (doc *DocumentCamt03100106) GetXmlName() *xml.Name {
	return &doc.XMLName
}

func (doc *DocumentCamt03100106) GetAttrs() []utils.Attr {
	return doc.Attrs
}

func (doc *DocumentCamt03100106) InspectDocument() interface{} {
	return &doc.RjctInvstgtn
}
...
func (doc *DocumentCamt03300106) GetXmlName() *xml.Name {
	return &doc.XMLName
}

func (doc *DocumentCamt03300106) GetAttrs() []utils.Attr {
	return doc.Attrs
}

func (doc *DocumentCamt03300106) InspectDocument() interface{} {
	return &doc.ReqForDplct
}
...
func (doc *DocumentCamt03400106) GetXmlName() *xml.Name {
	return &doc.XMLName
}

func (doc *DocumentCamt03400106) GetAttrs() []utils.Attr {
	return doc.Attrs
}

func (doc *DocumentCamt03400106) InspectDocument() interface{} {
	return &doc.Dplct
}
...
func (doc *DocumentCamt04700106) GetXmlName() *xml.Name {
	return &doc.XMLName
}

func (doc *DocumentCamt04700106) GetAttrs() []utils.Attr {
	return doc.Attrs
}

func (doc *DocumentCamt04700106) InspectDocument() interface{} {
	return &doc.RtrRsvatn
}
...
func (doc *DocumentCamt05700106) GetXmlName() *xml.Name {
	return &doc.XMLName
}

func (doc *DocumentCamt05700106) GetAttrs() []utils.Attr {
	return doc.Attrs
}

func (doc *DocumentCamt05700106) InspectDocument() interface{} {
	return &doc.NtfctnToRcv
}
...
func (doc *DocumentCamt05800106) GetXmlName() *xml.Name {
	return &doc.XMLName
}

func (doc *DocumentCamt05800106) GetAttrs() []utils.Attr {
	return doc.Attrs
}

func (doc *DocumentCamt05800106) InspectDocument() interface{} {
	return &doc.NtfctnToRcvCxlAdvc
}
...
func (doc *DocumentCamt05900106) GetXmlName() *xml.Name {
	return &doc.XMLName
}

func (doc *DocumentCamt05900106) GetAttrs() []utils.Attr {
	return doc.Attrs
}

func (doc *DocumentCamt05900106) InspectDocument() interface{} {
	return &doc.NtfctnToRcvStsRpt
}
