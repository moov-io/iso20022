...
func TestBusinessApplicationHeaderV02(t *testing.T) {
	...
	assert.Nil(t, err)
	assert.Equal(t, string(buf), `{"XMLName":"","Xmlns":"urn:iso:std:iso:20022:tech:xsd:head.001.001.02","Fr":{"OrgId":{},"FIId":{"FinInstnId":{}}},"To":{"OrgId":{},"FIId":{"FinInstnId":{}}},"BizMsgIdr":"BizMsgIdr","MsgDefIdr":"MsgDefIdr","CreDt":"2014-11-12T11:45:26.371"}`)
