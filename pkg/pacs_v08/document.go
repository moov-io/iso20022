...
func (doc *DocumentPacs00300108) GetXmlName() *xml.Name {
	return &doc.XMLName
}

func (doc *DocumentPacs00300108) GetAttrs() []utils.Attr {
	return doc.Attrs
}

func (doc *DocumentPacs00300108) InspectDocument() interface{} {
	return &doc.FIToFICstmrDrctDbt
}
