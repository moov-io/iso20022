...
func (doc *DocumentPacs01000104) GetXmlName() *xml.Name {
	return &doc.XMLName
}

func (doc *DocumentPacs01000104) GetAttrs() []utils.Attr {
	return doc.Attrs
}

func (doc *DocumentPacs01000104) InspectDocument() interface{} {
	return &doc.FIDrctDbt
}
...
func (doc *DocumentPacs02800104) GetXmlName() *xml.Name {
	return &doc.XMLName
}

func (doc *DocumentPacs02800104) GetAttrs() []utils.Attr {
	return doc.Attrs
}

func (doc *DocumentPacs02800104) InspectDocument() interface{} {
	return &doc.FIToFIPmtStsReq
}
